...
// on cache hits. Only RAM-backed pages are cached; SoC/MMIO accesses always
// fall through to the full MMU path.
//
// Each PPU thread owns its own instance (no synchronization needed).
// Invalidation is driven by TLB invalidation instructions (tlbie/tlbiel)
// and SLB.
