...
class XenonContext {
public:
  XenonContext(std::weak_ptr<RootBus> rootBusPtr, std::weak_ptr<RAM> ramPtr) :
  ...
  std::weak_ptr<RootBus> GetRootBus() { return rootBus; }
  std::weak_ptr<RAM> GetRAM() { return ram; }
