...
#define GETRC(name) GET_(name##x), GET_(name##x)
    ...
    fillTable<instructionHandlerJIT>(jitTable, 0x1F, 10, 1, {
      ...
      { 0x004, GET(tw) },
      { 0x006, GET(lvsl) },
      { 0x007, GET(lvx) }, // lvebx behaves like lvx
      { 0x008, GETRC(subfc) },
      //{ 0x208, GETRC(subfco) },
      //{ 0x009, GETRC(mulhdu) },
      { 0x00A, GETRC(addc) },
      ...
      { 0x020, GET(cmpl) },
      { 0x026, GET(lvsr) },
      { 0x027, GET(lvx) },  // lvehx behaves like lvx
      { 0x028, GETRC(subf) },
      //{ 0x228, GETRC(subfo) },
      { 0x035, GET(ldux) },
      { 0x036, GET(dcbst) },
      ...
      { 0x03C, GETRC(andc) },
      { 0x044, GET(td) },
      { 0x047, GET(lvx) },  // lvewx behaves like lvx
      //{ 0x049, GETRC(mulhd) },
      { 0x04B, GETRC(mulhw) },
      //{ 0x053, GET(mfmsr) },
      //{ 0x054, GET(ldarx) },
      ...
      { 0x1DC, GETRC(nand) },
      //{ 0x1F2, GET(slbia) },
      { 0x1E7, GET(stvx) },  // stvxl behaves like stvx
      { 0x1E9, GETRC(divd) },
      //{ 0x3E9, GETRC(divdo) },
      { 0x1EB, GETRC(divw) },
      //{ 0x3EB, GETRC(divwo) },
      ...
      //{ 0x353, GET(slbmfev) },
      { 0x356, GET(eieio) },
      { 0x387, GET(stvlx) },  // stvlxl behaves like stvlx
      //{ 0x393, GET(slbmfee) },
      //{ 0x396, GET(sthbrx) },
      { 0x39A, GETRC(extsh) },
      { 0x3A7, GET(stvrx) },  // stvrxl behaves like stvrx
      { 0x3BA, GETRC(extsb) },
      //{ 0x3D7, GET(stfiwx) },
      { 0x3DA, GETRC(extsw) },
      { 0x3D6, GET(icbi) },
