...
void PPCInterpreter::PPCInterpreter_sc(sPPEState* ppeState) {
  // Raise the exception.
  curThread.RaiseExc(ppuSystemCallEx);
...
void PPCInterpreter::PPCInterpreter_slbie(sPPEState* ppeState) {
  ...
  for (auto& slbEntry : curThread.SLB) {
    if (slbEntry.V && slbEntry.C == C && slbEntry.ESID == ESID) { slbEntry.V = false; }
  }
...
void PPCInterpreter::PPCInterpreter_rfid(sPPEState* ppeState) {
  ...
  if (!curThread.SPR.MSR.SF) curThread.NIA = static_cast<u32>(curThread.NIA);
}
...
void PPCInterpreter::PPCInterpreter_tw(sPPEState* ppeState) {
  ...
  if ((a < b && (_instr.bo & 0x10)) || (a > b && (_instr.bo & 0x8)) || (a == b && (_instr.bo & 0x4))
...
void PPCInterpreter::PPCInterpreter_twi(sPPEState* ppeState) {
  ...
  if (((_instr.bo & 0x10) && sA < sB) || ((_instr.bo & 0x8) && sA > sB) || ((_instr.bo & 0x4) && sA == sB)
      || ((_instr.bo & 0x2) && a < b) || ((_instr.bo & 0x1) && a > b)) {
...
void PPCInterpreter::PPCInterpreter_mfspr(sPPEState* ppeState) {
  ...
  switch (static_cast<eXenonSPR>(spr)) {
    case eXenonSPR::XER: GPRi(rs) = curThread.SPR.XER.hexValue; break;
    case eXenonSPR::LR: GPRi(rs) = curThread.SPR.LR; break;
    case eXenonSPR::CTR: GPRi(rs) = curThread.SPR.CTR; break;
    case eXenonSPR::DSISR: GPRi(rs) = curThread.SPR.DSISR; break;
    case eXenonSPR::DAR: GPRi(rs) = curThread.SPR.DAR; break;
    case eXenonSPR::DEC: GPRi(rs) = xenonContext->timeBase.ReadDEC(curThread.SPR.PIR); break;
    case eXenonSPR::HDEC: GPRi(rs) = xenonContext->timeBase.ReadHDEC(ppeState->ppuID); break;
    case eXenonSPR::SDR1: GPRi(rs) = ppeState->SPR.SDR1.hexValue; break;
    ...
    case eXenonSPR::SPRG3: GPRi(rs) = curThread.SPR.SPRG3; break;
    case eXenonSPR::PVR: GPRi(rs) = ppeState->SPR.PVR.hexValue; break;
    case eXenonSPR::HSPRG0: GPRi(rs) = curThread.SPR.HSPRG0; break;
    case eXenonSPR::HSPRG1: GPRi(rs) = curThread.SPR.HSPRG1; break;
    case eXenonSPR::RMOR: GPRi(rs) = ppeState->SPR.RMOR.hexValue; break;
    case eXenonSPR::HRMOR: GPRi(rs) = ppeState->SPR.HRMOR.hexValue; break;
    case eXenonSPR::LPCR: GPRi(rs) = ppeState->SPR.LPCR.hexValue; break;
    case eXenonSPR::TSCR: GPRi(rs) = ppeState->SPR.TSCR.hexValue; break;
    case eXenonSPR::TTR: GPRi(rs) = ppeState->SPR.TTR.hexValue; break;
    case eXenonSPR::PPE_TLB_Index_Hint: GPRi(rs) = curThread.SPR.PPE_TLB_Index_Hint.hexValue; break;
    case eXenonSPR::HID0: GPRi(rs) = ppeState->SPR.HID0.hexValue; break;
    case eXenonSPR::HID1: GPRi(rs) = ppeState->SPR.HID1.hexValue; break;
    case eXenonSPR::HID4: GPRi(rs) = ppeState->SPR.HID4.hexValue; break;
    case eXenonSPR::HID6: GPRi(rs) = ppeState->SPR.HID6.hexValue; break;
    case eXenonSPR::DABR: GPRi(rs) = curThread.SPR.DABR.hexValue; break;
    case eXenonSPR::PIR: GPRi(rs) = curThread.SPR.PIR; break;
    default:
      LOG_ERROR(Xenon, "{}(Thrd{:#d}) mfspr: Unknown SPR: 0x{:X}", ppeState->ppuName, static_cast<u8>(curThreadId),
                spr);
      break;
  }
}
...
void PPCInterpreter::PPCInterpreter_mtspr(sPPEState* ppeState) {
  ...
  switch (static_cast<eXenonSPR>(spr)) {
    case eXenonSPR::XER:
      ...
      break;
    case eXenonSPR::LR: curThread.SPR.LR = GPRi(rd); break;
    case eXenonSPR::CTR: curThread.SPR.CTR = GPRi(rd); break;
    case eXenonSPR::DSISR: curThread.SPR.DSISR = GPRi(rd); break;
    case eXenonSPR::DAR: curThread.SPR.DAR = GPRi(rd); break;
    case eXenonSPR::DEC: xenonContext->timeBase.WriteDEC(curThread.SPR.PIR, GPRi(rd) & 0xFFFFFFFF); break;
    case eXenonSPR::SDR1: ppeState->SPR.SDR1.hexValue = GPRi(rd); break;
    case eXenonSPR::SRR0: curThread.SPR.SRR0 = GPRi(rd); break;
    ...
    case eXenonSPR::SPRG0: curThread.SPR.SPRG0 = GPRi(rd); break;
    case eXenonSPR::SPRG1: curThread.SPR.SPRG1 = GPRi(rd); break;
    case eXenonSPR::SPRG2: curThread.SPR.SPRG2 = GPRi(rd); break;
    case eXenonSPR::SPRG3: curThread.SPR.SPRG3 = GPRi(rd); break;
    case eXenonSPR::TBLWO: xenonContext->timeBase.WriteTBL(GPRi(rd) & 0xFFFFFFFF); break;
    case eXenonSPR::TBUWO: xenonContext->timeBase.WriteTBU(GPRi(rd) & 0xFFFFFFFF); break;
    case eXenonSPR::HSPRG0: curThread.SPR.HSPRG0 = GPRi(rd); break;
    case eXenonSPR::HSPRG1: curThread.SPR.HSPRG1 = GPRi(rd); break;
    case eXenonSPR::HDEC: xenonContext->timeBase.WriteHDEC(ppeState->ppuID, GPRi(rd) & 0xFFFFFFFF); break;
    case eXenonSPR::RMOR: ppeState->SPR.RMOR.hexValue = GPRi(rd); break;
    case eXenonSPR::HRMOR: ppeState->SPR.HRMOR.hexValue = GPRi(rd); break;
    case eXenonSPR::LPCR: ppeState->SPR.LPCR.hexValue = GPRi(rd); break;
    case eXenonSPR::LPIDR: ppeState->SPR.LPIDR.hexValue = static_cast<u32>(GPRi(rd)); break;
    case eXenonSPR::TSCR: ppeState->SPR.TSCR.hexValue = static_cast<u32>(GPRi(rd)); break;
    case eXenonSPR::TTR: ppeState->SPR.TTR.hexValue = GPRi(rd); break;
    case eXenonSPR::PPE_TLB_Index: ppeState->SPR.PPE_TLB_Index.hexValue = GPRi(rd); break;
    ...
    case eXenonSPR::HID1: ppeState->SPR.HID1.hexValue = GPRi(rd); break;
    case eXenonSPR::HID4: ppeState->SPR.HID4.hexValue = GPRi(rd); break;
    case eXenonSPR::HID6: ppeState->SPR.HID6.hexValue = GPRi(rd); break;
    case eXenonSPR::DABR: curThread.SPR.DABR.hexValue = GPRi(rd); break;
    case eXenonSPR::DABRX: curThread.SPR.DABRX.hexValue = GPRi(rd); break;
    default:
      LOG_ERROR(Xenon, "{}(Thrd{:#d}) SPR 0x{:X} =0x{:X}", ppeState->ppuName, static_cast<u8>(curThreadId), spr,
                GPRi(rd));
      break;
  }
}
