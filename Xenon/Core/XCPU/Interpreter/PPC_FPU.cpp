...
void PPCInterpreter::PPCInterpreter_faddx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(FPRi(fra).asDouble() + FPRi(frb).asDouble());
...
void PPCInterpreter::PPCInterpreter_faddsx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(static_cast<f32>(FPRi(fra).asDouble() + FPRi(frb).asDouble()));
...
void PPCInterpreter::PPCInterpreter_fcfidx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(static_cast<f64>(static_cast<s64>(FPRi(frb).asDouble())));
...
void PPCInterpreter::PPCInterpreter_fmaddx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue((FPRi(fra).asDouble() * FPRi(frc).asDouble()) + FPRi(frb).asDouble());
...
void PPCInterpreter::PPCInterpreter_fmaddsx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(static_cast<f32>((FPRi(fra).asDouble() * FPRi(frc).asDouble()) + FPRi(frb).asDouble()));
...
void PPCInterpreter::PPCInterpreter_fmulx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(FPRi(fra).asDouble() * FPRi(frc).asDouble());
...
void PPCInterpreter::PPCInterpreter_fmulsx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(static_cast<f32>(FPRi(fra).asDouble() * FPRi(frc).asDouble()));
...
void PPCInterpreter::PPCInterpreter_frspx(PPU_STATE *ppuState) {
  ...
  */
  ...
  FPRi(frd).setValue(static_cast<f32>(FPRi(frb).asDouble()));
...
void PPCInterpreter::PPCInterpreter_mtfsfx(PPU_STATE *ppuState) {
  ...
  SET_FPSCR((static_cast<u32>(FPRi(frb).asU64() & mask)) | (GET_FPSCR & ~mask));
