...
namespace Xe::Xenon::SOC {
  ...
  // Secure ROM Block
#define XE_SOC_SECROM_BLOCK_START     0x8000020000000000ULL
#define XE_SOC_SECROM_BLOCK_SIZE      0x10000

  // Secure RAM Block
#define XE_SOC_SECRAM_BLOCK_START     0x8000020000010000ULL
#define XE_SOC_SECRAM_BLOCK_SIZE      0x10000

  // Security One-Time-Programmable Block
#define XE_SOC_SOCSECOTP_BLOCK_START  0x8000020000020000ULL
#define XE_SOC_SOCSECOTP_BLOCK_SIZE   0x4000

  // Security Engine Block
#define XE_SOC_SOCSECENG_BLOCK_START  0x8000020000024000ULL
#define XE_SOC_SOCSECENG_BLOCK_SIZE   0x2000

  // Secure Random Number Generator Block
#define XE_SOC_SOCSECRNG_BLOCK_START  0x8000020000026000ULL
#define XE_SOC_SOCSECRNG_BLOCK_SIZE   0x2000

  // CBI Block
#define XE_SOC_SOCCBI_BLOCK_START     0x8000020000028000ULL
#define XE_SOC_SOCCBI_BLOCK_SIZE      0x8000

  // Front Side Bus TTX Block
#define XE_SOC_SOCFSBTTX_BLOCK_START  0x8000020000030000ULL
#define XE_SOC_SOCFSBTTX_BLOCK_SIZE   0x8000

  // Front Side Bus TRX Block
#define XE_SOC_SOCFSBTRX_BLOCK_START  0x8000020000038000ULL
#define XE_SOC_SOCFSBTRX_BLOCK_SIZE   0x8000

  // Front Side Bus LTX Block
#define XE_SOC_SOCFSBLTX_BLOCK_START  0x8000020000040000ULL
#define XE_SOC_SOCFSBLTX_BLOCK_SIZE   0x8000

  // Front Side Bus LRX Block
#define XE_SOC_SOCFSBLRX_BLOCK_START  0x8000020000048000ULL
#define XE_SOC_SOCFSBLRX_BLOCK_SIZE   0x8000

  // Interrupts Block
#define XE_SOC_SOCINTS_BLOCK_START    0x8000020000050000ULL
#define XE_SOC_SOCINTS_BLOCK_SIZE     0x8000

  // Power Management Block
#define XE_SOC_SOCPMW_BLOCK_START     0x8000020000060000ULL
#define XE_SOC_SOCPMW_BLOCK_SIZE      0x1000

  // Pervasive Logic Block
#define XE_SOC_SECRRV_BLOCK_START     0x8000020000061000ULL
#define XE_SOC_SOCPRV_BLOCK_SIZE      0x1000
