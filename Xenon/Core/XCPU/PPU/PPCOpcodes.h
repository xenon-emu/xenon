...
extern void PPCInterpreterJIT_tdi(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_twi(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_td(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_tw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_bc(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_bclr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_bcctr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_mtspr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_mfmsr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_mtmsr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_mtmsrd(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_slbmte(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_slbie(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_rfid(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_sc(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
// LOAD/STORE JIT emitters
extern void PPCInterpreterJIT_lbz(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lbzu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lbzux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lbzx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lha(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhau(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhaux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhax(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhbrx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhz(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhzu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhzux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lhzx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lwa(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lwz(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_ldbrx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_lmw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_stbux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_sth(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_sthu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_sthux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stmw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stbx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stwbrx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stwu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stwux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stwx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_std(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_faddx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_faddsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fsubx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fsubsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fmulx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fmulsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fdivx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fdivsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fsqrtx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fsqrtsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fcmpu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fcmpo(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fnegx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fmrx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fselx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_fnabsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_fnmaddx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_fnmaddsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);

extern void PPCInterpreterJIT_lfd(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfdx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfdu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfdux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfs(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfsu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lfsux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);

extern void PPCInterpreterJIT_stfd(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfdx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfdu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfdux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfs(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfsx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfsu(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stfsux(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);

//
// VXU JIT emitters
//

extern void PPCInterpreterJIT_dss(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_dst(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_dstst(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_vand(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vand128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vandc(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vandc128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_vor(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vor128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vnor(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vnor128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vxor(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vxor128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vsel(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vsel128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltisb(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltish(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltisw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltisw128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltb(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vsplth(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vspltw128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vslb(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vslh(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vslw(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
extern void PPCInterpreterJIT_vsldoi(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_vsldoi128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);

extern void PPCInterpreterJIT_lvx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvx128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvlx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvlx128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvrx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvrx128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvsl(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvsl128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvsr(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_lvsr128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);

extern void PPCInterpreterJIT_stvx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvx128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvebx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvehx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvewx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvewx128(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_stvlx(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
...
// MMU JIT Emitters
//
extern void PPCInterpreterJIT_tlbsync(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_slbia(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_tlbie(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
extern void PPCInterpreterJIT_tlbiel(sPPEState *ppeState, JITBlockBuilder *b, uPPCInstr instr);
