...
#define NAND_64MB_SIZE 0x4200000
    ...
    public:
      SFCX(const std::string& deviceName, u64 size, const std::string& nandLoadPath, PCIBridge* parentPCIBridge,
           RAM* ram);
      ~SFCX();
    ...
    private:
      ...
      // Mounted NAND Image.
      std::unique_ptr<Base::ReadWriteStorage> mountedNANDImage{};
