...
Xe::PCIDev::EHCI1::EHCI1::EHCI1(const std::string &deviceName, u64 size) :
...
void Xe::PCIDev::EHCI1::EHCI1::Write(u64 writeAddress, const u8 *data, u64 size) 
{}

void Xe::PCIDev::EHCI1::EHCI1::MemSet(u64 writeAddress, s32 data, u64 size)
{}

void Xe::PCIDev::EHCI1::EHCI1::ConfigWrite(u64 writeAddress, const u8 *data, u64 size) {
