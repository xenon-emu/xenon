...
void Xe::PCIDev::EHCI1::EHCI1::Write(u64 writeAddress, const u8 *data, u8 byteCount) 
{}

void Xe::PCIDev::EHCI1::EHCI1::ConfigWrite(u64 writeAddress, const u8 *data, u8 byteCount) {
