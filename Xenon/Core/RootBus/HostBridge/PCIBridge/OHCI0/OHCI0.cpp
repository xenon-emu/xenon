...
void Xe::PCIDev::OHCI0::OHCI0::Read(u64 readAddress, u8 *data, u8 byteCount)
{}

void Xe::PCIDev::OHCI0::OHCI0::ConfigRead(u64 readAddress, u8 *data, u8 byteCount) {
  memcpy(data, &pciConfigSpace.data[static_cast<u8>(readAddress)], byteCount);
}

void Xe::PCIDev::OHCI0::OHCI0::Write(u64 writeAddress, const u8 *data, u8 byteCount)
{}

void Xe::PCIDev::OHCI0::OHCI0::ConfigWrite(u64 writeAddress, const u8 *data, u8 byteCount) {
