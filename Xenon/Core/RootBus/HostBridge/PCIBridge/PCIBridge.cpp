...
bool PCIBridge::RouteInterrupt(u8 prio, u32 targetCPU) {
  ...
  case PRIO_ENET:
    ...
    break;
  case PRIO_GRAPHICS:
    if (targetCPU != 0) { xenonIIC->genInterrupt(PRIO_GRAPHICS, targetCPU); } 
    else { LOG_ERROR(PCIBridge, "Generated GPU interrupt with no target cpu."); }
