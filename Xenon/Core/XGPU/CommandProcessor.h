...
namespace Xe::XGPU {
  ...
  private:
    ...
    bool ExecutePacketType3_EVENT_WRITE_EXT(RingBuffer* ringBuffer, u32 packetData, u32 dataCount);
    ...
    bool ExecutePacketType3_DRAW(RingBuffer* ringBuffer, u32 packetData, u32 dataCount, u32 vizQueryCondition,
