...
enum class XenonGPUEndianFormat : u32
{
	FormatUnspecified = 0,
	Format8in16 = 1,
	Format8in32 = 2,
...
enum class XenonGPUEndianFormat128 : u32
{
	FormatUnspecified = 0,
	Format8in16 = 1,
	Format8in32 = 2,
...
enum class XenonPrimitiveType : u32
{
	PrimitiveNone = 0x00,
...
enum class XenonIndexFormat : u32
{
	Index16,
	Index32,
};

enum class XenonShaderType : u32
{
	ShaderVertex = 0,
	ShaderPixel = 1,
};

enum class XenonMsaaSamples : u32
{
	MSSA1X = 0,
	MSSA2X = 1,
	MSSA4X = 2,
...
enum class XenonColorRenderTargetFormat : u32
{
...
enum class XenonDepthRenderTargetFormat : u32
{
	Format_D24S8 = 0,
	Format_D24FS8 = 1,
};

enum class XenonModeControl : u32
{
	Ignore = 0,
	ColorDepth = 4,
	Depth = 5,
...
enum class XenonCopyCommand : u32
{
	Raw = 0,
	Convert = 1,
	ConstantOne = 2,
...
enum class XenonColorFormat : u32
{
	Unknown = 0,
	Format_8 = 2,
	Format_1_5_5_5 = 3,
...
enum class XenonVertexFormat : u32
{
	Format_8_8_8_8 = 6,
	Format_2_10_10_10 = 7,
	Format_10_11_11 = 16,
...
enum class XenonFrontFace : u32
{
	CW,
	CCW,
};

enum class XenonFillMode : u32
{
	Point,
	Line,
	Solid,
...
enum class XenonTextureType : u32
{
	Texture_1D,
	Texture_2D,
	Texture_3D,
...
enum class XenonTextureFormat : u32
{
	Format_1_REVERSE = 0,
	Format_1 = 1,
	Format_8 = 2,
...
enum class XenonTextureDimension : u32
{
	Dimmension_1D = 0,
	Dimmension_2D = 1,
	Dimmension_3D = 2,
...
enum class XenonTextureFormatType : u32
{
	Uncompressed,
	Compressed,
};

enum class XenonClampMode : u32
{
	Repeat = 0,
	MirroredRepeat = 1,
	ClampToEdge = 2,
...
enum class XenonTextureFilter : u32
{
	Point = 0,
	Linear = 1,
	BaseMap = 2,
...
enum class XenonAnisoFilter : u32
{
	Disabled = 0,
	Max_1_1 = 1,
	Max_2_1 = 2,
...
enum class XenonBorderColor : u32
{
	AGBR_Black = 0,
	AGBR_White = 1,
	ACBYCR_BLACK = 2,
