...
namespace DX11Microcode
{
	...
	public:
		...
		ExprVertexFetch( ExprNode* src, u32 fetchSlot, u32 fetchOffset, u32 stride, EFetchFormat format, const bool isFloat, const bool isSigned, const bool isNormalized );
		...
		inline const u32	GetSlot() const { return m_fetchSlot; }
		inline const u32	GetOffset() const { return m_fetchOffset; }

		inline const u32 GetStride() const { return m_fetchStride; }
	...
	public:
		...
		ExprTextureFetch( ExprNode* src, u32 fetchSlot, TextureType textureType );
