...
namespace crc32
{
	...
	extern const u32 Crc32Lookup[MaxSlice][256]; // extern is needed to keep compiler happey

	/// compute CRC32 (bitwise algorithm)
	u32 crc32_bitwise(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
	...
	u32 crc32_halfbyte(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		const u8* current = (const u8*) data;

		/// look-up table for half-byte, same as crc32Lookup[0][16*i]
		static const u32 Crc32Lookup16[16] =
		{
	...
	u32 crc32_1byte(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		const u8* current = (const u8*) data;
	...
	u32 crc32_4bytes(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32  crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		...
		const u8* currentChar = (const u8*) current;
	...
	u32 crc32_8bytes(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		const u32* current = (const u32*) data;
	...
	u32 crc32_4x8bytes(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		const u32* current = (const u32*) data;
	...
	u32 crc32_16bytes(const void* data, size_t length, u32 previousCrc32 = 0)
	{
		u32 crc = ~previousCrc32; // same as previousCrc32 ^ 0xFFFFFFFF
		const u32* current = (const u32*) data;
	...
	u32 crc32_16bytes_prefetch(const void* data, size_t length, u32 previousCrc32 = 0, size_t prefetchAhead = 256)
	{
	...
	u32 crc32_fast(const void* data, size_t length, u32 previousCrc32 = 0)
	{
	...
	const u32 Crc32Lookup[MaxSlice][256] =
	{
...
u32 XenonGPUCalcCRC( const void* memory, const u32 memorySize )
{
	return crc32::crc32_16bytes_prefetch( memory, memorySize );
}

u64 XenonGPUCalcCRC64( const void* memory, const u32 memorySize )
{
	return XenonGPUCalcCRC( memory, memorySize );
}

//----

const char* XenonGPUGetColorRenderTargetFormatName( const XenonColorRenderTargetFormat format )
{
	switch ( format )
	{
		case XenonColorRenderTargetFormat::Format_8_8_8_8: return "8_8_8_8";
		case XenonColorRenderTargetFormat::Format_8_8_8_8_GAMMA: return "8_8_8_8_GAMMA";
		case XenonColorRenderTargetFormat::Format_2_10_10_10: return "_10_10_10";
		case XenonColorRenderTargetFormat::Format_2_10_10_10_FLOAT: return "2_10_10_10_FLOAT";
		case XenonColorRenderTargetFormat::Format_16_16: return "16_16";
		case XenonColorRenderTargetFormat::Format_16_16_16_16: return "16_16_16_16";
		case XenonColorRenderTargetFormat::Format_16_16_FLOAT: return "16_16_FLOAT";
		case XenonColorRenderTargetFormat::Format_16_16_16_16_FLOAT: return "16_16_16_16_FLOAT";
		case XenonColorRenderTargetFormat::Format_2_10_10_10_unknown: return "2_10_10_10_unknown";
		case XenonColorRenderTargetFormat::Format_2_10_10_10_FLOAT_unknown: return "2_10_10_10_FLOAT_unknown";
		case XenonColorRenderTargetFormat::Format_32_FLOAT: return "32_FLOAT";
		case XenonColorRenderTargetFormat::Format_32_32_FLOAT: return "32_32_FLOAT";
	}

	return "Unknown";
}

const char* XenonGPUGetDepthRenderTargetFormatName( const XenonDepthRenderTargetFormat format )
{
	switch ( format )
	{
		case XenonDepthRenderTargetFormat::Format_D24FS8: return "D24FS8";
		case XenonDepthRenderTargetFormat::Format_D24S8: return "D24S8";
	}

	return "Unknown";
}

const char* XenonGPUGetMSAAName( const XenonMsaaSamples msaa )
{
	switch ( msaa )
	{
		case XenonMsaaSamples::MSSA1X: return "NO MSAA";
		case XenonMsaaSamples::MSSA2X: return "2x MSAA";
		case XenonMsaaSamples::MSSA4X: return "4x MSAA";
	}

	return "Unknown";
}

const char* XenonGPUTextureFormatName( const XenonTextureFormat format )
{
	switch ( format )
	{
		case XenonTextureFormat::Format_1_REVERSE: return "1_REVERSE";
		case XenonTextureFormat::Format_1: return "1";
		case XenonTextureFormat::Format_8: return "8";
		case XenonTextureFormat::Format_1_5_5_5: return "1_5_5_5";
		case XenonTextureFormat::Format_5_6_5: return "5_6_5";
		case XenonTextureFormat::Format_6_5_5: return "6_5_5";
		case XenonTextureFormat::Format_8_8_8_8: return "8_8_8_8";
		case XenonTextureFormat::Format_2_10_10_10: return "2_10_10_10";
		case XenonTextureFormat::Format_8_A: return "8_A";
		case XenonTextureFormat::Format_8_B: return "8_B";
		case XenonTextureFormat::Format_8_8: return "8_8";
		case XenonTextureFormat::Format_Cr_Y1_Cb_Y0: return "Cr_Y1_Cb_Y0";
		case XenonTextureFormat::Format_Y1_Cr_Y0_Cb: return "Y1_Cr_Y0_Cb";
		case XenonTextureFormat::Format_8_8_8_8_A: return "8_8_8_8_A";
		case XenonTextureFormat::Format_4_4_4_4: return "4_4_4_4";
		case XenonTextureFormat::Format_10_11_11: return "10_11_11";
		case XenonTextureFormat::Format_11_11_10: return "11_11_10";
		case XenonTextureFormat::Format_DXT1: return "DXT1";
		case XenonTextureFormat::Format_DXT2_3: return "DXT2_3";
		case XenonTextureFormat::Format_DXT4_5: return "DXT4_5";
		case XenonTextureFormat::Format_24_8: return "24_8";
		case XenonTextureFormat::Format_24_8_FLOAT: return "24_8_FLOAT";
		case XenonTextureFormat::Format_16: return "16";
		case XenonTextureFormat::Format_16_16: return "16_16";
		case XenonTextureFormat::Format_16_16_16_16: return "16_16_16_16";
		case XenonTextureFormat::Format_16_EXPAND: return "16_EXPAND";
		case XenonTextureFormat::Format_16_16_EXPAND: return "16_16_EXPAND";
		case XenonTextureFormat::Format_16_16_16_16_EXPAND: return "16_16_16_16_EXPAND";
		case XenonTextureFormat::Format_16_FLOAT: return "16_FLOAT";
		case XenonTextureFormat::Format_16_16_FLOAT: return "16_16_FLOAT";
		case XenonTextureFormat::Format_16_16_16_16_FLOAT: return "16_16_16_16_FLOAT";
		case XenonTextureFormat::Format_32: return "32";
		case XenonTextureFormat::Format_32_32: return "32_32";
		case XenonTextureFormat::Format_32_32_32_32: return "32_32_32_32";
		case XenonTextureFormat::Format_32_FLOAT: return "32_FLOAT";
		case XenonTextureFormat::Format_32_32_FLOAT: return "32_32_FLOAT";
		case XenonTextureFormat::Format_32_32_32_32_FLOAT: return "32_32_32_32_FLOAT";
		case XenonTextureFormat::Format_32_AS_8: return "32_AS_8";
		case XenonTextureFormat::Format_32_AS_8_8: return "32_AS_8_8";
		case XenonTextureFormat::Format_16_MPEG: return "16_MPEG";
		case XenonTextureFormat::Format_16_16_MPEG: return "16_16_MPEG";
		case XenonTextureFormat::Format_8_INTERLACED: return "8_INTERLACED";
		case XenonTextureFormat::Format_32_AS_8_INTERLACED: return "32_AS_8_INTERLACED";
		case XenonTextureFormat::Format_32_AS_8_8_INTERLACED: return "32_AS_8_8_INTERLACED";
		case XenonTextureFormat::Format_16_INTERLACED: return "16_INTERLACED";
		case XenonTextureFormat::Format_16_MPEG_INTERLACED: return "16_MPEG_INTERLACED";
		case XenonTextureFormat::Format_16_16_MPEG_INTERLACED: return "16_16_MPEG_INTERLACED";
		case XenonTextureFormat::Format_DXN: return "DXN";
		case XenonTextureFormat::Format_8_8_8_8_AS_16_16_16_16: return "8_8_8_8_AS_16_16_16_16";
		case XenonTextureFormat::Format_DXT1_AS_16_16_16_16: return "DXT1_AS_16_16_16_16";
		case XenonTextureFormat::Format_DXT2_3_AS_16_16_16_16: return "DXT2_3_AS_16_16_16_16";
		case XenonTextureFormat::Format_DXT4_5_AS_16_16_16_16: return "DXT4_5_AS_16_16_16_16";
		case XenonTextureFormat::Format_2_10_10_10_AS_16_16_16_16: return "2_10_10_10_AS_16_16_16_16";
		case XenonTextureFormat::Format_10_11_11_AS_16_16_16_16: return "10_11_11_AS_16_16_16_16";
		case XenonTextureFormat::Format_11_11_10_AS_16_16_16_16: return "11_11_10_AS_16_16_16_16";
		case XenonTextureFormat::Format_32_32_32_FLOAT: return "32_32_32_FLOAT";
		case XenonTextureFormat::Format_DXT3A: return "DXT3A";
		case XenonTextureFormat::Format_DXT5A: return "DXT5A";
		case XenonTextureFormat::Format_CTX1: return "CTX1";
		case XenonTextureFormat::Format_DXT3A_AS_1_1_1_1: return "DXT3A_AS_1_1_1_1";
		case XenonTextureFormat::Format_2_10_10_10_FLOAT: return "2_10_10_10_FLOAT";
	}
...
CodeExpr::CodeExpr( ICodeExpr* ptrFromNew )
	: m_expr( ptrFromNew )
{
}

CodeExpr::CodeExpr( const CodeExpr& other )
{
	m_expr = other.m_expr ? other.m_expr->Copy() : nullptr;
}
...
CodeExpr& CodeExpr::operator=( const CodeExpr& other )
{
...
std::string CodeExpr::ToString() const
{
	if ( m_expr )
...
CodeStatement::CodeStatement( ICodeStatement* ptrFromNew )
	: m_statement( ptrFromNew )
{
}

CodeStatement::CodeStatement( const CodeStatement& other )
{
	m_statement = other.m_statement ? other.m_statement->Copy() : nullptr;
}
...
CodeStatement& CodeStatement::operator=( const CodeStatement& other )
{
	if ( m_statement != other.m_statement )
	{
		if ( m_statement )
		{
			m_statement->Release();
		...
		if ( other.m_statement )
			m_statement = other.m_statement->Copy();
	}

	return *this;
}

std::string CodeStatement::ToString() const
{
	if ( m_statement )
...
{
	// will we fit inside the smaller buffer ?
	const size_t txtLen = strlen(txt);
	if ( m_longBuf.empty() )
	{
		if ( m_bufLength + txtLen < MAX_LEN )
		{
			// append in small buffer
			strcpy_s( m_buf + m_bufLength, MAX_LEN - m_bufLength, txt );
		}
		else
		{
			// convert to big buffer and append in the big buffer
			m_longBuf = m_buf;
			m_longBuf += txt;
			m_buf[0] = 0;
		}
	...
	// advance length
	m_bufLength += (u32)txtLen;
	DEBUG_CHECK( strlen(c_str()) == m_bufLength );
	return *this;
}
...
{
	// will we fit inside the smaller buffer ?
	const size_t txtLen = txt.m_bufLength;
	if ( m_longBuf.empty() )
	{
		if ( m_bufLength + txtLen < MAX_LEN )
		{
			// append in small buffer
			strcpy_s( m_buf + m_bufLength, MAX_LEN - m_bufLength, txt.c_str() );
		}
		else
		{
			// convert to big buffer and append in the big buffer
